...
class EstimatedInPlaceEditor(EstimationToolsBase):
    ...
    def match_request(self, req):
        return req.path_info == '/estimationtools/editestimated.js'

    def process_request(self, req):
        data = {'field': self.estimation_field}
        return 'editestimated.html', {'data': data}, 'text/javascript'
    ...
    def post_process_request(self, req, template, data, content_type):
        ...
        if realm in ('query', 'report', 'wiki', 'milestone', 'roadmap') \
            ...
            add_script(req, '/estimationtools/editestimated.js')
